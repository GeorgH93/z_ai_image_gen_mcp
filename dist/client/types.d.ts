...
export type VideoModel = 'cogvideox-3' | 'viduq1-text' | 'viduq1-image' | 'viduq1-start-end' | 'vidu2-image' | 'vidu2-start-end' | 'vidu2-reference';
...
export type CreateVideoRequest = CogVideoX3Request | ViduQ1TextRequest | ViduQ1ImageRequest | ViduQ1StartEndRequest | Vidu2ImageRequest | Vidu2StartEndRequest | Vidu2ReferenceRequest;
